...
public class FavoriteRepoWithId extends UseCase<Boolean, Long> {

    private final FavoriteRepoRepository repository;

    public FavoriteRepoWithId(FavoriteRepoRepository repository, Scheduler runScheduler, Scheduler postScheduler) {
