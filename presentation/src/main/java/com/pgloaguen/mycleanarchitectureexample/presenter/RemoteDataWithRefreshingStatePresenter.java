...
public abstract class RemoteDataWithRefreshingStatePresenter<T, P> {
    ...
    private final UseCase<List<T>, P> getUserRepoUseCase;
    ...
    public RemoteDataWithRefreshingStatePresenter(UseCase<List<T>, P> getUserRepoUseCase) {
    ...
    private void executeUseCase() {
        ...
        compositeDisposable.add(executeUseCase(getUserRepoUseCase).subscribe(this::onSuccess, this::onError));
    }
