...
public abstract class BaseFragmentWithRemoteDataWithRefreshingState<S> extends BaseFragment implements PresenterListener<RemoteDataWithRefreshingState<S>> {
